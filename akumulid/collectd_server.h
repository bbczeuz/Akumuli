/**
 * Copyright (c) 2016 Claudius Zingerli <akumulimail@zeuz.ch>
 * based on works of:
...
/** Collectd server for data ingestion.
  */
class CollectdServer : public std::enable_shared_from_this<CollectdServer>, public Server
{
